...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element_info in symbol_quantity_list:
        if periodic_table_dict[element_info[0]]:
            amu = periodic_table_dict[element_info[0]][ATOMIC_MASS_INDEX]
            elemental_formula_mass = amu * element_info[1]
            total_molar_mass += elemental_formula_mass
...
def main():
    ...
    sample_number_of_moles = 1 / molar_mass * sample_mass
    # Print the molar mass.
    print(f"{molar_mass:.5f} grams/mole")
    # Print the number of moles.
    print(f"{sample_number_of_moles:.5f} moles")

    # for element_data in periodic_table:
    #     print(element_data)
