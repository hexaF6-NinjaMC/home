...
def test_read_dict():
    ...
    assert students["751766201"] == "James Smith"
    assert students["751762102"] == "Esther Einboden"
    assert students["052058203"] == "Cassidy Benavidez"
    assert students["323021604"] == "Joel Hatch"
    assert students["251041405"] == "Brianna Ririe"
    assert students["001152306"] == "Stefano Hisler"
    assert students["182706207"] == "Hyeonbeom Park"
    assert students["124712708"] == "Maren Thomas"
    assert students["212505409"] == "Tyler Clark"
